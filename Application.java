...
public class Application {
	...
	public static void main(String[] args) {
		...
		System.out.println(monRoman.getTitre() + "; écrit par " + monRoman.getAuteur() + "; aux éditions " + monRoman.getEditeur() + "; publié en " + monRoman.getAnnee() + "; " + monRoman.getType());
		...
		System.out.println(monMagasine.getTitre() + "; écrit par " + monMagasine.getAuteur() + "; aux éditions " + monMagasine.getEditeur() + "; publié en " + monMagasine.getAnnee() + "; " + monMagasine.getType());
		...
		System.out.println(monChilBook.getTitre() + "; écrit par " + monChilBook.getAuteur() + "; aux éditions " + monChilBook.getEditeur() + "; publié en " + monChilBook.getAnnee() + "; " + monChilBook.getType());
	}
}
